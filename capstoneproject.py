...
Original file is located at
    https://colab.research.google.com/drive/1pKQVRTR2B0GEfVQWghU1oiidDEM0xj00
"""
...
plt.title ("Not Fraudulent Transactions and Fraudulent Transactions")
plt.xlabel ("Class")
...
"""To determine the best-performing model, we typically consider both the AUPRC (Under the Precision-Recall CuArea rve) and the confusion matrix. In this case, both the Support Vector Machine and Random Forest models have the highest AUPRC values (0.921 and 0.918, respectively). Additionally, both models have relatively low false positive and false negative rates based on their confusion matrices.
